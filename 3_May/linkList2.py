...
print('Removing the node with value 5-')
myList.remove(5)
myList.display()
print('Index of element 13-',end ='')
print(myList.lastIndexOf(13))#Getting the last index of the element 13 from the list
print('Updated list - ')
myList.set(4,5555)# changing the element at the index 4 to 5555
myList.display()